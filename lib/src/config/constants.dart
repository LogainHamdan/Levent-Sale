...
const String getAdsByCategoryUrl = '$baseUrl/search/ads/category';
...
const String getCitiesUrl = 'http://34.22.173.63:8080/users/cities';
const String getGovernoratesUrl =
    'http://34.22.173.63:8080/users/governorates/get/all';
