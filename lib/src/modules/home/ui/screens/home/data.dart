...
final List<Map<String, dynamic>> categories = [
  ...
  {'name': 'الوظائف', 'image': jobsIcon, 'count': '10K'},
  {'name': 'أجهزة الكمبيوتر', 'image': computerIcon, 'count': '7.8K'},
  {'name': 'الملابس', 'image': clothesIcon, 'count': '14K'},
  {'name': 'الخدمات', 'image': servicesIcon, 'count': '6.5K'},
  {'name': 'السفر', 'image': travelIcon, 'count': '5.3K'},
  {'name': 'الألعاب', 'image': gamesIcon, 'count': '11K'},
  {'name': 'الحيوانات', 'image': animalsIcon, 'count': '4.8K'},
  {'name': 'الأطعمة', 'image': foodIcon, 'count': '7.2K'},
  {'name': 'المجوهرات', 'image': accessoriesIcon, 'count': '9K'},
