...
class SectionDetails extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(create: (_) => CreateAdSectionDetailsProvider()),
        ChangeNotifierProvider(create: (_) => UpdateAdSectionDetailsProvider()),
      ],
      child: Consumer2<CreateAdSectionDetailsProvider,
